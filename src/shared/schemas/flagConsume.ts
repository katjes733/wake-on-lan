...
// callers now compute withinSeconds dynamically from their own uptime
// (see the agent's boot-hooks mode) rather than a fixed guess, so this
// ceiling only matters for an extreme, multi-hour boot-to-login gap.
